document.write (`
    <div>
        <div class="flex flex-col justify-between bg-slate-700 text-white lg:flex-row lg:px-20">
            <div class="flex basis-1/3 flex-col border-y-gray-300 p-[25px] lg:border-r lg:border-zinc-400">
                <div class="flex flex-row items-center gap-x-[10px] pb-[10px]">
        ...
        <div class="flex flex-col border-t border-zinc-400 bg-slate-700 p-[10px] pt-[20px]">
        ...
        <div class="flex flex-col bg-slate-700 px-20 p-[20px] text-center text-white lg:flex-row justify-between">
